...
class CarControllerParams:
  ...
  TORQUE_TO_ANGLE_MULTIPLIER_K = 16.8  # Higher = easier to influence the steering manually, divided by vEgo
  TORQUE_TO_ANGLE_MULTIPLIER_MAX = 5  # Maximum torque multiplier for very low speeds, to avoid infinity
